...
![***Figure 2***: Illustration of Residual Autoencoding =600x](/assets/images/work/cv/DC-AE/residual.png#mdimg)
...
![***Figure 3***: High spatial-compression autoencoders suffer from significant reconstruction accuracy drops when generalizing from low-resolution to high-resolution.  =500x](/assets/images/work/cv/DC-AE/high-res.png#mdimg)
...
![***Figure 4***: Illustration of Decoupled High-Resolution Adaptation  =600x](/assets/images/work/cv/DC-AE/decoupled.png#mdimg)
...
![***Table 1***: Ablation Study on Patch Size and Autoencoder’s Spatial Compression Ratio.  =600x](/assets/images/work/cv/DC-AE/table1.png#mdimg)
...
![***Table 2***: Class-Conditional Image Generation Results on ImageNet $512 \times 512$.  =600x](/assets/images/work/cv/DC-AE/table2.png#mdimg)

![***Table 3***: $1024\times 1024$ and $2048 \times 2048$ Image Generation Results.  =600x](/assets/images/work/cv/DC-AE/table3.png#mdimg)

![***Table 4***: Text-to-Image Generation.  =600x](/assets/images/work/cv/DC-AE/table4.png#mdimg)
